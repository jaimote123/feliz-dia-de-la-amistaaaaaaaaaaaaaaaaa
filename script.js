...
fetch('treelove.svg')
  ...
  .then(svgText => {
    ...
    const heartPaths = allPaths.filter(el => {
      ...
      return style.includes('#701ddd') || style.includes('#3a2a96');
    });
...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi amigo muy especial Josuecito:

Desde el primer momento en que llegaste a mi vida supe que eras alguien diferente. Tu forma de pensar, tu manera de ver el mundo y tu esencia tan única hicieron que te ganaras un lugar muy importante en mi corazón, incluso a la distancia entre México y Colombia.

Quiero que sepas que valoro profundamente tu presencia en mi vida. Agradezco cada conversación, cada risa compartida y cada momento en el que, aun estando lejos, me hiciste sentir acompañado. Has sido una persona muy significativa para mí.

Aunque nuestro amorío terminó hace mucho tiempo, el cariño que te tengo sigue intacto. Te quiero mucho, de una forma sincera y tranquila, y siempre te voy a guardar un respeto enorme. Respeto tus gustos, tus preferencias, tus decisiones y el camino que elijas para tu vida. Todo lo que hagas, lo que sueñes y lo que construyas, cuenta con mi admiración y mi apoyo desde aquí.

Gracias por haber sido parte de mi historia y por seguir siendo alguien tan especial. La distancia no borra lo bonito que compartimos ni el aprecio tan grande que te tengo.
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con cariño y respeto, El negro.";
